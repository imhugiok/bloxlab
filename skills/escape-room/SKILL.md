...
# /hugoblox:escape-room — Escape room con puzzles justos
...
5. **Pistas:** coloca pistas legibles en el entorno (notas, marcas, colores) con decals válidos o `SurfaceGui` (apóyate en `/hugoblox:game-ui` para textos/pistas).
...
## 4. Cierre
Resume sala(s), puzzles y cadena. Ofrece: probar con `start_stop_play`, más puzzles/salas, cronómetro/pistas, o NPCs (`/hugoblox:npc`).
